...
Drawing.SphereGraph = function(opts) {
  ...
  */
  function init() {
    ...
    var cloudsScale = 1.025;

    var cloudTexture = THREE.ImageUtils.loadTexture('./img/clouds.png');
    var cloudGeometry = new THREE.SphereGeometry(sphere_radius*cloudsScale, 200, 100);
  ...
  // function initLeapOld() {
  //   leapController = new Leap.Controller({ enableGestures: false, useAllPlugins: true });
  ...
  //     leapController.use('boneHand', {targetEl:document.body});
  //     // loopController.plugins.boneHand.targetEl = document.body;
  //     // loopController.plugins.boneHand.scene = scene;
